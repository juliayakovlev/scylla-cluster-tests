...
class BaseScyllaCluster:  # pylint: disable=too-many-public-methods
    ...
    def check_cluster_health(self):
        ...
        nemesis_count = len(self.nemesis)
        ...
        self.check_nodes_running_nemesis_count(nemesis_count)
    ...
    def check_nodes_running_nemesis_count(self, nemesis_count):
        nodes_running_nemesis = [node for node in self.nodes if node.running_nemesis]

        # Support parallel nemesis: nemesis_count is
        if len(nodes_running_nemesis) <= nemesis_count:
            return
