...
ScyllaBenchLogEvent.add_subevent_type("DataValidationError", severity=Severity.ERROR,
                                      regex=r"doesn't match |failed to validate data|failed to verify checksum|corrupt checksum or data|"
                                            r"data corruption")
ScyllaBenchLogEvent.add_subevent_type("ParseDistributionError", severity=Severity.ERROR,
