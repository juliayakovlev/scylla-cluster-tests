...
class BaseLogEntity:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, name, command="", search_locally=False, collect_to_parent=False):
        """
         collect_to_parent: relevant for cluster:
        ...
        self.collect_to_parent = collect_to_parent
            ...
            for log_entity in self.log_entities:
                try:
                    log_entity.collect(node=node,
                                       local_dst=local_parent_dir if log_entity.collect_to_parent else local_node_dir,
