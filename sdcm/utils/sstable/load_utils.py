...
class SstableLoadUtils:
    ...
    def distribute_test_files_to_cluster_nodes(cls, nodes, test_data: List[TestDataInventory]) -> List:
        ...
        # map_files_to_node = [[test_data.pop(1), cls.get_random_item(nodes)],
        #                      [test_data.pop(1), cls.get_random_item(nodes)]
        #                      ]
        #
        ...
        #             node_to_load_to = cls.get_random_item(nodes)
        #             for _ in range(invariant):
        #                 map_files_to_node.append([cls.get_random_item(test_data, pop=True), node_to_load_to])
        #
        #     if mod:
