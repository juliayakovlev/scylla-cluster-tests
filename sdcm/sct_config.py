...
class SCTConfiguration(dict):
    ...
    config_options = [
        ...
        dict(name="perf_test_throttle_steps", env="SCT_PERF_TEST_THROTTLE_STEPS", type=list,
             help="Used for gradual performance test. Define throttle for load step in ops. Example: [100000, 150000]"),
    ...
    test_required_params = {"perf-regression-gradual": ["perf_max_ops", "perf_test_throttle_steps", "perf_threads"]}
