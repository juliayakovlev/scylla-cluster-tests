...
class ClusterTester(db_stats.TestStatsMixin, unittest.TestCase):
    ...
    def run_fullscan(self, ks_cf, loader_node, db_node, page_size=100000):
        ...
        try:
            ...
            result = {'exit_code': 0, 'stdout': 'finished successfully', 'stderr': ''}
        except Exception as details:
            result = {'exit_code': 1, 'stdout': '', 'stderr': details.message}

        FullScanEvent(type='finish', db_node_ip=db_node.ip_address, ks_cf=ks_cf, result=result)
    ...
    def run_fullscan_thread(self, ks_cf='random', interval=1, duration=None):
        ...
        def run_in_thread():
            ...
            while current - start < duration:
                ...
                if db_node.termination_event.isSet():
                    break
